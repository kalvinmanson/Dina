...
<div class="container">
    <div class="row">
      <div class="col-sm-6">
        <h4>Devoluciones:</h4>
        <p>Si presento algún problema con el pedido y desea solicitar el cambio de alguno de los productos seleccione el pedido el pedido del cual requiere hacer el cambio o devolución.</p>
